<?=$this->extend('layouts/main');?>
		...
		<div class="card">
            ...
            <div class="card-body">
            <form id="partyForm" action="<?=base_url('party/createParty');?>" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="inputContactperson" id="inputContactperson" >
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="inputAlternatecontactno" id="inputAlternatecontactno" >
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="inputPartytype" id="inputPartytype" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="inputBc" id="inputBcYes" value="Yes" >
                                            <label class="form-check-label" for="inputBcYes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input checked class="form-check-input" type="radio" name="inputBc" id="inputBcNo" value="No" >
